        ...
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                <View style={styles.group_btn}>
                    <Pressable style={[styles.btn1, styles.btn]} onPress={()=>setColor('vs_blue')} />
                    <Pressable style={[styles.btn2, styles.btn]} onPress={()=>setColor('vs_red')} />
                    <Pressable style={[styles.btn3, styles.btn]} onPress={()=>setColor('vs_silver')} />
                    <Pressable style={[styles.btn4, styles.btn]} onPress={()=>setColor('vs_black')} />
                </View>
                <Pressable 
